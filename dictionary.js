const myDictionary = [
    ...
    { rus: 'единственный', heb: 'יחיד', speak: 'яхид', type: 'мужской' },
    ...
    { rus: 'ученик', heb: 'תלמיד', speak: 'талмид', type: 'мужской' },
    { rus: 'ученица', heb: 'תלמידה', speak: 'талмида', type: 'женский' },
    { rus: 'книга', heb: 'ספר', speak: 'сефер', type: 'мужской' },
    { rus: 'тетрадь', heb: 'מחברת', speak: 'мехаберет', type: 'женский' },
    { rus: 'окно', heb: 'חלון', speak: 'халон', type: 'мужской' },
