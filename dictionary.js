const myDictionary = [
    ...
    { rus: 'мне, у меня (for me)', heb: 'לי', speak: 'лі', type: '-' },
    { rus: 'тебе, у тебя (for you)(муж.)', heb: 'לְךָ', speak: 'льэхА', type: 'мужской' },
    { rus: 'тебе, у тебя (for you)(жен.)', heb: 'לָךְ', speak: 'льах', type: 'женский' },
    { rus: 'нам, у нас (for us)', heb: 'לָנוּ', speak: 'лАну', type: 'множественное' },
    { rus: 'вам, у вас (for you)(муж.)', heb: 'לָכֶם', speak: 'лахЭм', type: 'мужское, множественное' },
    { rus: 'вам, у вас (for you)(жен.)', heb: 'לָכֵן', speak: 'лахЭн', type: 'женское, множественное' },
    { rus: 'ему, у него (for him)', heb: 'לוֹ', speak: 'льО', type: 'мужской' },
    { rus: 'ей, у неё (for her)', heb: 'לָהּ', speak: 'льА', type: 'женский' },
    { rus: 'им, у них (for them)(муж.)', heb: 'לָהֶם', speak: 'лаhЭм', type: 'мужское, множественное' },
    { rus: 'им, у них (for them)(жен.)', heb: 'לָהֶן', speak: 'лаhЭн', type: 'женское, множественное' },
    { rus: 'этому, у этого (for it)', heb: 'לָזֶה', speak: 'лэзЭ', type: 'к предмету' },
