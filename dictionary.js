const myDictionary = [
    ...
    ///////// 2025.03.21 /////////////////////////
    { rus: 'животное', heb: 'חיה', speak: 'хайА', type: '' },
    { rus: 'осёл', heb: 'חמון', speak: 'хамОн', type: '' },
    ...
    { rus: 'мышь', heb: 'עכבר', speak: 'ахбАр', type: '' },
    { rus: 'медведь', heb: 'דוב', speak: 'дов', type: '' },
    { rus: 'паук', heb: 'עכביש', speak: 'акавИщ', type: '' },
    { rus: 'верблюд', heb: 'גמל', speak: 'гамАль', type: '' },
    { rus: 'орёл', heb: 'נשר', speak: 'нЭщэр', type: '' },
    { rus: 'краб', heb: 'סרטן', speak: 'сартАн', type: '' },
];
