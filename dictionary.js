const myDictionary = [
    ...
    { rus: 'спина, назад, тыл', heb: 'גב', speak: 'гэв', type: '' },
    { rus: 'крыша', heb: 'גג', speak: 'гаг', type: '' },
    { rus: 'ткань, холст', heb: 'בד', speak: 'бад', type: '' },
    { rus: 'рыба', heb: 'דג', speak: 'даг', type: '' },
    { rus: 'волновался', heb: 'דאג', speak: 'дАаг', type: '' },
    { rus: 'одежда', heb: 'בגד', speak: 'бЭгэд', type: '' },
    { rus: 'руль', heb: 'הגה', speak: 'хЭгэ', type: '' },
    { rus: 'любовь', heb: 'אהבה', speak: 'ахавА', type: '' },
    
    ///////// 2018.11.10 /////////////////////////
    { rus: 'крючок', heb: 'וו', speak: 'ву', type: '' },
    { rus: 'кукла', heb: 'בובה', speak: 'бубА', type: '' },
    { rus: 'одинокий', heb: 'בודד', speak: 'бОдэд', type: '' },
    
    ///////// 2018.11.11 /////////////////////////
    { rus: 'волк', heb: 'זאב', speak: 'зЭэв', type: '' },
    { rus: 'муха', heb: 'זבוב', speak: 'звУв', type: '' },
    { rus: 'это', heb: 'זה', speak: 'зэ', type: '' },
    { rus: 'золото', heb: 'זהב', speak: 'заhАв', type: '' },
