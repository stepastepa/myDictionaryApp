const myDictionary = [
    ...
    { rus: 'наслаждайся (он)', heb: 'תֵּהָנֶה', speak: 'таhАнэ', type: 'мужской' },
    { rus: 'наслаждайся (она)', heb: 'תֵּהָנִי', speak: 'тэhанИ', type: 'женский' },
    { rus: 'наслаждайтесь (группа)', heb: 'תִּהֱנוּ', speak: 'тіhэнУ', type: 'множественное' },
    ...
    { rus: 'наслаждается (он)', heb: 'נֶהֱנֶה', speak: 'нэhэнэ', type: 'мужской' },
    { rus: 'наслаждается (она)', heb: 'הֱנֵית / נֶהֱנָה', speak: 'нэhэнА / hэнЭт', type: 'женский' },
    { rus: 'наслаждаются (много муж.)', heb: 'נֶהֱנִים', speak: 'нэhэнИм', type: 'мужской' },
    { rus: 'наслаждаются (много жен.)', heb: 'נֶהֱנוֹת', speak: 'нэhэнОт', type: 'женский' }
];
