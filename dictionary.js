const myDictionary = [
    ...
    { rus: 'вам, у вас (муж.)', heb: 'לָכֶם', speak: 'лахЭм', type: 'мужское, множественное' },
    { rus: 'вам, у вас (жен.)', heb: 'לָכֵן', speak: 'лахЭн', type: 'женское, множественное' },
    { rus: 'ему, у него', heb: 'לוֹ', speak: 'льО', type: 'мужской' },
    { rus: 'ей, у неё', heb: 'לָהּ', speak: 'льА', type: 'женский' },
    { rus: 'им, у них (муж.)', heb: 'לָהֶם', speak: 'лаhЭм', type: 'мужское, множественное' },
    { rus: 'им, у них (жен.)', heb: 'לָהֶן', speak: 'лаhЭн', type: 'женское, множественное' },
    { rus: 'этому, у этого', heb: 'לָזֶה', speak: 'лэзЭ', type: 'к предмету' },
