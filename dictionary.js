const myDictionary = [
    ...
    { rus: 'мне, для меня (for me)', heb: 'לי', speak: 'лі', type: '-' },
    { rus: 'тебе, для тебя (for you)(муж.)', heb: 'לְךָ', speak: 'льэхА', type: 'мужской' },
    { rus: 'тебе, для тебя (for you)(жен.)', heb: 'לָךְ', speak: 'льах', type: 'женский' },
    { rus: 'ему, для него (for him)', heb: 'לוֹ', speak: 'льО', type: 'мужской' },
    { rus: 'ей, для неё (for her)', heb: 'לָהּ', speak: 'льА', type: 'женский' },
    { rus: 'этому, для этого (for it)', heb: 'לָזֶה', speak: 'льэзЭ', type: 'к предмету' },
    { rus: 'нам, для нас (for us)', heb: 'לָנוּ', speak: 'лАну', type: 'множественное' },
    { rus: 'им, для них (for them)(муж.)', heb: 'לָהֶם', speak: 'льахЭм', type: 'мужское, множественное' },
    { rus: 'им, для них (for them)(жен.)', heb: 'לָהֶן', speak: 'льахЭн', type: 'женское, множественное' },
