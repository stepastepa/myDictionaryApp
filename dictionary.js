const myDictionary = [
    ...
    { rus: 'ко мне (to me)', heb: 'לי', speak: 'лі', type: '-' },
    { rus: 'к тебе (to you)(муж.)', heb: 'לְךָ', speak: 'льэхА', type: 'мужской' },
    { rus: 'к тебе (to you)(жен.)', heb: 'לָךְ', speak: 'льах', type: 'женский' },
    { rus: 'к нему (to him)', heb: 'לוֹ', speak: 'льО', type: 'мужской' },
    { rus: 'к ней (to her)', heb: 'לָהּ', speak: 'льА', type: 'женский' },
    { rus: 'к этому (to it)', heb: 'לָזֶה', speak: 'льэзЭ', type: 'к предмету' },
    { rus: 'к нам (to us)', heb: 'לָנוּ', speak: 'лАну', type: 'множественное' },
    { rus: 'к ним (to them)(муж.)', heb: 'לָהֶם', speak: 'льахЭм', type: 'мужское, множественное' },
    { rus: 'к ним (to them)(жен.)', heb: 'לָהֶן', speak: 'льахЭн', type: 'женское, множественное' },
