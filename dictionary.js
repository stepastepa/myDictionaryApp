const myDictionary = [
    ...
    ///////// 2025.05.06 /////////////////////////
    { rus: 'of (у, чей, чья, чьё, чьи)', heb: 'של', speak: 'щэль', type: 'предлог (принадлежность)' },
    { rus: 'книга Дины (книга, которая принадлежит Дине)', heb: 'הספר של דינה', speak: 'haсЭфэр щэль Дина', type: '-' },
