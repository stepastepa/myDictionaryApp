const myDictionary = [
    ...
    { rus: 'шампанское', heb: 'שמפניה', speak: 'шампАнья', type: '' },
    { rus: 'автобус', heb: 'אוטובוס', speak: 'Отобус', type: '' },
    { rus: 'шовинизм', heb: 'שוביניזם', speak: 'шовинизЕм', type: '' },
    { rus: 'цивилизация', heb: 'ציוויליזציה', speak: 'цивилизацЫя', type: '' },
    { rus: 'рапорт, отчёт', heb: 'רפורט', speak: 'рапОрт', type: '' },
    { rus: 'карамель', heb: 'קרמל', speak: 'карамЕль', type: '' },
    { rus: 'репертуар', heb: 'רפרטואר', speak: 'репертуАр', type: '' },
    { rus: 'реформа', heb: 'רפורמה', speak: 'рефОрма', type: '' },
    { rus: 'рецепт', heb: 'רצפט', speak: 'рецЕпт', type: '' },
    { rus: 'ремонт', heb: 'רמונט', speak: 'ремОнт', type: '' },
    { rus: 'флора', heb: 'פלורה', speak: 'флОра', type: '' },
    { rus: 'целлюлоза', heb: 'צלולוזה', speak: 'целюлозА', type: '' },
    { rus: 'фонетика', heb: 'פונטיקה', speak: 'фонетика', type: '' },
    { rus: 'шок', heb: 'שוק', speak: 'шок', type: '' },
    { rus: 'комунна', heb: 'קומונה', speak: 'комУна', type: '' },
    { rus: 'керамика', heb: 'קרמיקה', speak: 'керАмика', type: '' },
    { rus: 'эмбарго', heb: 'אמברגו', speak: 'эмбАрго', type: '' },
    { rus: 'эпизод', heb: 'אפיזוד', speak: 'эпизОд', type: '' },
    { rus: 'эстетика', heb: 'אסתטיקה', speak: 'эстЕтика', type: '' },
    { rus: 'террор', heb: 'טרור', speak: 'терОр', type: '' },
    { rus: 'инсулин', heb: 'אינסולין', speak: 'инсулИн', type: '' },
    { rus: 'идиллия', heb: 'אידיליה', speak: 'идИлья', type: '' },
    { rus: 'агроном', heb: 'אגרונום', speak: 'агронОм', type: '' },
    { rus: 'демократия', heb: 'דמוקרטיה', speak: 'демокрАтья', type: '' },
    { rus: 'инфляция', heb: 'אינפלציה', speak: 'инфлЯцья', type: '' },
    { rus: 'одеколон', heb: 'אודקולון', speak: 'одэкольОн', type: '' },
    { rus: 'депрессия', heb: 'דפרסיה', speak: 'депресьИя', type: '' },
    { rus: 'инстинкт', heb: 'אינסטינקט', speak: 'инстИнкет', type: '' },
    { rus: 'халтура', heb: 'חלטורה', speak: 'хальтУра', type: '' },
    { rus: 'алгебра', heb: 'אלגברה', speak: 'альгебрА', type: '' },
    { rus: 'элемент', heb: 'אלמנט', speak: 'элемЕнт', type: '' },
    { rus: 'альбом', heb: 'אלבום', speak: 'альбОм', type: '' },
    { rus: 'инфекция', heb: 'אינפקציה', speak: 'инфЕкцья', type: '' },
    { rus: 'автономия', heb: 'אוטונומיה', speak: 'отонОмья', type: '' },
    { rus: 'ислам', heb: 'אסלאם', speak: 'ислАм', type: '' },
    { rus: 'атлас', heb: 'אטלס', speak: 'Атлас', type: '' },
    { rus: 'имитация', heb: 'אימיטציה', speak: 'имитацИя', type: '' },
    { rus: 'администратор', heb: 'אדמיניסטרטור', speak: 'администратОр', type: '' },
    { rus: 'атом, герметичный, непрозрачный', heb: 'אטום', speak: 'атОм', type: '' },
    { rus: 'изоляция', heb: 'איזולציה', speak: 'изоляцьИя', type: '' },
    { rus: 'инкогнито', heb: 'אינקוגניטו', speak: 'инкогнитО', type: '' },
    { rus: 'алтьтернатива', heb: 'אלטרנטיבה', speak: 'альтернатИва', type: '' },
    { rus: 'ирония', heb: 'אירוניה', speak: 'ирОнья', type: '' },
    { rus: 'алкоголь', heb: 'אלכוהול', speak: 'Алькохоль', type: '' },
    { rus: 'аллергия', heb: 'אלרגיה', speak: 'альЕргья', type: '' },
    { rus: 'монолог', heb: 'מונולוג', speak: 'монольОг', type: '' },
    { rus: 'графомания', heb: 'גרפומניה', speak: 'графомАнья', type: '' },
    { rus: 'хулиган', heb: 'חוליגן', speak: 'хулигАн', type: '' },
    { rus: 'дилетант', heb: 'דילטנט', speak: 'дилетАнт', type: '' },
    ...
    ///////// 2025.02.02 /////////////////////////
    { rus: 'бакалея', heb: 'מכולת', speak: 'макОлет', type: '' },
    { rus: 'овсяная каша', heb: 'שיבולת שועל', speak: 'щибОлет щуАль', type: '' },
    { rus: 'овсяные хлопья', heb: 'קוואקר', speak: 'кwAкер', type: '' },
