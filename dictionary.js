const myDictionary = [
    ...
    ///////// 2025.03.24 /////////////////////////
    { rus: 'животные', heb: 'חיות', speak: 'хайОт', type: '' },
    { rus: 'обезьяна', heb: 'קוף', speak: 'коф', type: '' },
    { rus: 'змея', heb: 'נחש', speak: 'нахАщ', type: '' },
    { rus: 'муха', heb: 'זבוב', speak: 'звУв', type: '' },
    { rus: 'насекомые', heb: 'חרק', speak: 'хАрк', type: '' },
    { rus: 'кролик, заяц', heb: 'ארנב', speak: 'арнАв', type: '' },
    { rus: 'петух', heb: 'תרנגול', speak: 'тарнэгОль', type: 'мужской' },
    { rus: 'курица', heb: 'תרנגולת', speak: 'тарнэгольЭт', type: 'женский' },
    { rus: 'домашние питомцы', heb: 'חיית מחמד', speak: 'хайАт махмАд', type: '' },
    { rus: 'корова', heb: 'פרה', speak: 'парА', type: '' },
    { rus: 'сова', heb: 'ינשוף', speak: 'йанщУф', type: '' },
    { rus: 'пчела', heb: 'דבורה', speak: 'дэборА', type: '' },
    { rus: 'хвост', heb: 'זנב', speak: 'занАв', type: '' },
    { rus: 'свинья', heb: 'חזיר', speak: 'хазИр', type: '' },
];
