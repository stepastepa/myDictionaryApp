const myDictionary = [
    ...
    ///////// 2025.03.04 /////////////////////////
    { rus: 'Ты впорядке? (к мужчине)', heb: 'אַתָּה בְּסֵדֶר', speak: 'атА бэсЭдэр', type: 'мужской' },
    { rus: 'Ты впорядке? (к женщине)', heb: 'אַתְּ בְּסֵדֶר', speak: 'ат бэсЭдэр', type: 'женский' },
];
