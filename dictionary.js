const myDictionary = [
    ...
    ///////// 2025.02.03 /////////////////////////
    { rus: 'просить, требовать', heb: 'לבקש', speak: 'левакеш', type: '' },
    { rus: 'деревня, село', heb: 'כפר', speak: 'кфар', type: '' },
    ///////// 2025.02.06 /////////////////////////
    { rus: 'архитектор', heb: 'אדריכלית', speak: 'адрихалит', type: '' },
    { rus: 'архитектура', heb: 'אדריכלות', speak: 'адрихалут', type: '' },
    { rus: 'архитектор ландшафтный', heb: 'אדריכל נוף', speak: 'адрихаль ноф', type: '' },
    { rus: 'архитектура ландшафтная', heb: 'אדריכלות נוף', speak: 'адрихалут ноф', type: '' },
    ///////// 2025.02.07 /////////////////////////
    { rus: 'число (номер)', heb: 'מספר', speak: 'миспар', type: '' },
    { rus: 'единственный', heb: 'יחיד', speak: 'яхид', type: '' },
    { rus: 'единственная (единица)', heb: 'יחידה', speak: 'яхидa', type: 'женский' },
    ...
    { rus: 'мужской', heb: 'זכר', speak: 'захар', type: '' },
    { rus: 'женский', heb: 'נקבה', speak: 'некева', type: '' },
    { rus: 'ученик', heb: 'תלמיד', speak: 'талмид', type: '' },
    { rus: 'ученица', heb: 'תלמידה', speak: 'талмида', type: '' },
    { rus: 'книга', heb: 'ספר', speak: 'сефер', type: '' },
    { rus: 'тетрадь', heb: 'מחברת', speak: 'мехаберет', type: '' },
    { rus: 'окно', heb: 'חלון', speak: 'халон', type: '' },
    { rus: 'магазин', heb: 'חנות', speak: 'ханут', type: '' }
