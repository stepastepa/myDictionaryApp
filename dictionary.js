const myDictionary = [
    ...
    { rus: 'этому, у этого, для этого (for it)', heb: 'לָזֶה', speak: 'льэзЭ', type: 'к предмету' },
    { rus: 'нам, у нас, для нас (for us)', heb: 'לָנוּ', speak: 'лАну', type: 'множественное' },
    { rus: 'им, у них, для них (for them)(муж.)', heb: 'לָהֶם', speak: 'льахЭм', type: 'мужское, множественное' },
    { rus: 'им, у них, для них (for them)(жен.)', heb: 'לָהֶן', speak: 'льахЭн', type: 'женское, множественное' },
