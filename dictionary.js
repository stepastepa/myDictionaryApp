const myDictionary = [
    ...
    ///////// 2018.11.21 /////////////////////////
    { rus: 'мир, привет!', heb: 'שלום', speak: '' },
    { rus: 'стол, таблица', heb: 'שולחן', speak: '' },
    { rus: 'платье', heb: 'שמלה', speak: '' },
    { rus: 'весёлый, рад', heb: 'שמח', speak: '' },
    { rus: 'слышал, звук, слух', heb: 'שמע', speak: '' },
    ///////// 2018.11.22 /////////////////////////
    { rus: 'апельсин, оранжевый', heb: 'תפוז', speak: '' },
    { rus: 'яблоко, набухший', heb: 'תפוח', speak: '' },
    { rus: 'занятый, занято', heb: 'תפוס', speak: '' },
    { rus: 'неожиданный, удивительно', heb: 'מפתיע', speak: '' },
    { rus: 'ключ', heb: 'מפתח', speak: '' },
    { rus: 'промышленность, индустрия', heb: 'תעשיה', speak: '' },
    { rus: 'надежда', heb: 'תקוה', speak: '' },


    ///////// 2025.02.03 /////////////////////////
    { rus: 'просить, требовать', heb: 'לבקש', speak: 'левакеш' },
    { rus: 'деревня, село', heb: 'כפר', speak: 'кфар' },
    ///////// 2025.02.06 /////////////////////////
    { rus: 'архитектор', heb: 'אדריכלית', speak: 'адрихалит' },
    { rus: 'архитектура', heb: 'אדריכלות', speak: 'адрихалут' },
    { rus: 'архитектор ландшафтный', heb: 'אדריכל נוף', speak: 'адрихаль ноф' },
    { rus: 'архитектура ландшафтная', heb: 'אדריכלות נוף', speak: 'адрихалут ноф' },
    ///////// 2025.02.07 /////////////////////////
    { rus: 'число (номер)', heb: 'מספר', speak: 'миспар' },
    { rus: 'единственный', heb: 'יחיד', speak: 'яхид' },
    { rus: 'единственная (единица)', heb: 'יחידה', speak: 'яхид', type: 'женский' },
    { rus: 'много (мужской)', heb: 'רבים', speak: 'рабим', type: 'мужской' },
    { rus: 'много (женский)', heb: 'רבות', speak: 'работ', type: 'женский' },
    { rus: 'двойной (пара)', heb: 'זוגי', speak: 'зуги' },
    { rus: 'род', heb: 'מין', speak: 'мин' },
    { rus: 'мужской', heb: 'זכר', speak: 'захар' },
    { rus: 'женский', heb: 'נקבה', speak: 'некева' },
    { rus: 'ученик', heb: 'תלמיד', speak: 'талмид' },
    { rus: 'ученица', heb: 'תלמידה', speak: 'талмида' },
    { rus: 'книга', heb: 'ספר', speak: 'сефер' },
    { rus: 'тетрадь', heb: 'מחברת', speak: 'мехаберет' },
    { rus: 'окно', heb: 'חלון', speak: 'халон' },
    { rus: 'магазин', heb: 'חנות', speak: 'ханут' }
